...
% Você deverá usar o predicado `um_entre`, que você criou em uma prática anterior.

/*
Esta é a solução, verificada no site
?- solucao(Avioes).
Avioes = [aviao(farfarelli, preta, hidraulico, cerveja, tenis), 
		  aviao(rui, azul, bussola, cafe, futebol), 
		  aviao(milton, vermelha, altimetro, leite, natacao), 
          aviao(walter, branca, radio, cha, equitacao), 
          aviao(nascimento, verde, temperatura, agua, pesca)] ;
*/
