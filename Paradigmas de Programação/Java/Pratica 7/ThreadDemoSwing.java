...
class ThreadDemoSwing extends javax.swing.JFrame {
  ...
  private void runThread(int id) {
    ...
    thr[id] = new AppenderThread(this.getTextArea(id), id);
    thr[id].start();
  }
...
class AppenderThread extends Thread {
  ...
  protected static final int SLEEP_2 = 1500;
  protected int id_thr;
  
  
  public AppenderThread(JTextArea textArea, int id_thr) {
  ...
  public void run() {
    ...
    try {
      while (true) {
        ...
        if(id_thr == 1){
            final String str = "Counting: " + i +" - "+ "Randon number: " + aux + "\n";
            textArea.append(str);
